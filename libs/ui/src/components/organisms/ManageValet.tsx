...
export const ManageValets = ({
    ...
    return (
        <div className="p-2 space-y-3 bg-gray-25">
            ...
            <p>
                Our valet will whisk your car away to its reserved spot and bring it back when you&apos;re ready. It&apos;s like magic, but with cars!
            </p>
            <Switch
                checked={showValet}
                onChange={(e) => {
                ...
                <div>
                    <div className="mb-6 space-y-3">
                        <p className="text-sm text-gray">
                            Want your car delivered somewhere else? No problem! Choose a different drop-off point and we&apos;ll make sure your ride is there waiting for you.
                        </p>
                        <Switch
                            ...
                            label="Add a diffrent drop off location?"
                        />
                    </div>
                    <Map
                        initialViewState={{
